...
import { studentsList } from "@/assets/marketing";
  ...
  return (
    <MarketingLayout>
      ...
      <section className="py-24 lg:py-32 bg-muted/20 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_0%,hsl(var(--teal)/0.06),transparent_60%)] pointer-events-none" />
        <div className="container relative mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.25em] text-teal block mb-4">See it in action</span>
            <h2 className="text-3xl lg:text-[2.75rem] font-bold text-foreground">
              Your student roster, beautifully organised
            </h2>
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Every student, instrument, guardian, and grade — searchable and always up to date.
            </p>
          </motion.div>
          ...
          >
            <BrowserFrameLight url="app.lessonloop.net/students" animate={false}>
              <img
                src={studentsList}
                alt="LessonLoop student list showing student profiles, instruments, grades, and guardian contact details"
