...
import { attendanceReal } from "@/assets/marketing";
        ...
        <div className="container relative mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl lg:text-[2.75rem] font-bold text-foreground">
              Your real attendance register
            </h2>
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Mark attendance in seconds. Track patterns, flag absences, and keep parents informed — all from one view.
            </p>
          </motion.div>
          ...
          >
            <BrowserFrameLight url="app.lessonloop.net/attendance" animate={false}>
              <img
                src={attendanceReal}
                alt="LessonLoop attendance register showing daily lesson attendance with present, absent, and late status tracking"
