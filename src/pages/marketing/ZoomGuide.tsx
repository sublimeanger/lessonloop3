          ...
          >
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <ol className="text-muted-foreground space-y-3 list-decimal list-inside mb-4">
                <li>Log in to LessonLoop and navigate to <strong>Settings → Zoom Meetings</strong>.</li>
                <li>Click the <strong>"Connect"</strong> button next to the Zoom Account card.</li>
                <li>You will be redirected to Zoom's authorisation page. Sign in with your Zoom account and click <strong>"Allow"</strong> to grant LessonLoop access.</li>
                <li>Once authorised, you will be redirected back to LessonLoop. A green <strong>"Connected"</strong> badge confirms the integration is active.</li>
              </ol>
              <p className="text-muted-foreground mb-4">
              ...
              <h3 className="text-xl font-medium text-foreground mt-6 mb-3">Automatic Meeting Creation</h3>
              <p className="text-muted-foreground mb-4">
              ...
              <h3 className="text-xl font-medium text-foreground mt-6 mb-3">What Data Is Accessed</h3>
              <p className="text-muted-foreground mb-4">LessonLoop accesses the following from your Zoom account:</p>
              ...
              <h3 className="text-xl font-medium text-foreground mt-6 mb-3">From LessonLoop</h3>
              <ol className="text-muted-foreground space-y-3 list-decimal list-inside mb-4">
              ...
              <h3 className="text-xl font-medium text-foreground mt-6 mb-3">From Zoom</h3>
              <p className="text-muted-foreground mb-4">You can also revoke access directly from your Zoom account:</p>
              <ol className="text-muted-foreground space-y-3 list-decimal list-inside mb-4">
