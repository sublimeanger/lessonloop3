  ...
  return (
    <section className="relative pt-24 pb-20 lg:pt-32 lg:pb-28 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
        ...
        >
          <span className="px-4 py-2 rounded-xl bg-primary/10 border border-primary/20 text-primary text-sm font-bold tracking-wide">
            {badgeLeft}
          </span>
          <span className="w-8 h-8 rounded-full bg-[hsl(var(--ink))] flex items-center justify-center">
            <Zap className="w-3.5 h-3.5 text-white" />
          </span>
          <span className="px-4 py-2 rounded-xl bg-muted border border-border/60 text-muted-foreground text-sm font-bold tracking-wide">
