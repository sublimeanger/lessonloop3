...
**Last updated:** 2026-05-10 (after 17th-session — DEDICATED money-path systematic clearing: 15 Invoicing & Payments rows promoted 🟡→🟢 (6 A-bucket already-covered + 9 B-bucket via new §24 auth-gate contract tests); §11.4.7 race fix; cumulative 47 🟢 / 117 🟡)
**Owner:** Jamie McKaye
...
- **Total rows:** 180
- **State:** 47 🟢 verified / 117 🟡 structurally-verified-pending-browser / 6 🔴 launch-blockers / 10 ⏸ deferred-post-launch / **0 ❓ untouched**
...
- **Money-path status (Invoicing & Payments cluster):** 18 of 23 rows green (was 0 pre-s16; 3 promoted s16, 15 promoted s17). Remaining 5 🟡 are all C-bucket: Invoice PDF generation; Send invoice email (internal copy); Backfill default PM (admin); Auto-pay run (installment cron); Recurring billing run create. All deferred to s18 — need full E2E or cron-fire verification.
...
- **Recalibrated bar (s15 onwards):** ≥5 rows backfilled to 🟢 per session is non-negotiable; per Jamie's 2026-05-10 recalibration, audit hygiene is part of the world-class launch readiness criterion. After s17, money-path is ~78% green; remaining is C-bucket. Next dedicated workstream after money-path closes (s18) is Auth & Onboarding (14 rows, 1 🟢).
