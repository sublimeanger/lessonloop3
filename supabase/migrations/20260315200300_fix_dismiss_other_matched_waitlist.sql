-- FIX 5: Dismiss other matched waitlist entries when one is booked
-- When confirm_makeup_booking books one entry, other entries matched to the
-- same lesson still point to the now-full slot. This migration updates
-- confirm_makeup_booking to reset those stale matches.
