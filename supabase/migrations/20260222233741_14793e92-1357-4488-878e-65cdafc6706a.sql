...
-- Add max_participants column to lessons
ALTER TABLE public.lessons ADD COLUMN max_participants integer DEFAULT NULL;

-- Replace find_waitlist_matches with capacity check
...
BEGIN
  ...
  -- Capacity check: if lesson has a max and it's already full, return nothing
