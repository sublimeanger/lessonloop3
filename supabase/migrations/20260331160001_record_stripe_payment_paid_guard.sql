-- ============================================================
-- FIN-H6: Add paid-status guard to record_stripe_payment
-- Prevents overpayment race when two PaymentIntents resolve
-- for the same invoice concurrently.
-- ============================================================
...
BEGIN
  ...
  -- Guard: skip payment on already-paid invoices (prevents overpayment race)
