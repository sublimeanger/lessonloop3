...
serve(wrapEdgeFn("stripe-billing-history", async (req) => {
  ...
  try {
    ...
    // No-args form hits /auth/v1/user which rejects them on this project.
    ...
    // J24-A: org-scoped Stripe key. Live by default; only e2e test org
    // routes through STRIPE_TEST_SECRET_KEY (organisations.stripe_test_mode).
