...
const SAFE_MESSAGES: SafeErrorMap = {
  exact: {
    ...
    "Only org owners/admins can manage billing": 403,
    "Organisation not found": 404,
    "No billing account found. Please subscribe first.": 404,
  },
};

serve(wrapEdgeFn("stripe-customer-portal", async (req) => {
  ...
  try {
    ...
    return classifyAndRespond(error, SAFE_MESSAGES, corsHeaders, "stripe-customer-portal");
  }
}));
