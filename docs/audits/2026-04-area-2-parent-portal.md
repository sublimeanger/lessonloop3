...
4. **CC-3 hardcoded currency sweep — PORTAL ONLY shipped 2026-04-29** (Lovable commit 37163c52). Closed J1-F15 (HIGH) + J3-F2/J3-F10/J3-F15 (LOW, currency portion) across 13 sites in 4 portal files. **Pre-flight grep surfaced 44+ hardcoded-GBP sites across the broader codebase; staged sweep continues:** PR 3 = admin pages/dashboards/reports/settings/hooks (~25 sites); PR 4 = edge functions including parent-loopassist-chat (closes CC-F8); PR 5 = foundation review of OrgContext, lib/utils, onboarding-setup, test fixtures.
